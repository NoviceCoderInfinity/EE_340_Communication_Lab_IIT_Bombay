...
class Q4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Q4")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_RECTANGULAR,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/anupam/Desktop/LAB_1/shor.wav', True)
...
def main(top_block_cls=Q4, options=None):
